...
void Controller::Update(float deltaTime)
{
    ...
    if (m_keyStates[SDL_SCANCODE_W])
    {
        ...
        DirectX::XMStoreFloat3(&forward,
            DirectX::XMVectorScale(m_camera->GetForward(), m_movePower * acceleration * deltaTime));
    ...
    if (m_keyStates[SDL_SCANCODE_D])
    {
        ...
        DirectX::XMStoreFloat3(&right,
            DirectX::XMVectorScale(m_camera->GetRight(), m_movePower * acceleration * deltaTime));
    ...
    if (m_keyStates[SDL_SCANCODE_Q])
    {
        ...
        DirectX::XMStoreFloat3(&up,
            DirectX::XMVectorScale(m_camera->GetUp(), m_movePower * acceleration * deltaTime));
